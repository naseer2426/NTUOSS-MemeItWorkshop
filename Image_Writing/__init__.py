def make_meme(string, filename, isWhite=True, optional=1):
    ...
    font = ImageFont.truetype("/app/Fonts/impact.ttf", fontSize)
...
if __name__ == "__main__":
    make_meme("/Users/ashivalagar/Desktop/NTUOSS-MemeItWorkshop/Completed/output2.png".replace('/',
                                                                                               ' ').replace('-', ' '), '/Users/ashivalagar/Desktop/NTUOSS-MemeItWorkshop/Completed/output2.png', True, 6)
